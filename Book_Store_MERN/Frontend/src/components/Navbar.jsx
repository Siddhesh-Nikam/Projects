...
//         <>
//             <li>
//                 <a href="/" className='font-bold text-2xl' >Home</a>
//             </li>

//             <li>
//                 <a href="/course" className='font-bold text-2xl' >Course</a>
//             </li>

//             <li>
//                 <a className='font-bold text-2xl' >Contact</a>
//             </li>

//             <li>
//                 <a className='font-bold text-2xl' >About</a>
//             </li>
//         </>
//     );
